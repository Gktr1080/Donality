...
const page = () => {
  ...
  return (
    <section className="w-full h-full flex justify-center items-center p-10">
      <div className="w-1/2 rounded-md bg-gray-200 flex flex-col justify-between items-center p-5">
        <div className="w-full flex flex-col justify-between items-center">
          <h1 className="text-xl font-bold text-black">Request Items</h1>
          <p className="text-sm">
            Welcome to Donatly donation. Please fill out the below form.
        ...
        <div className="w-full flex flex-col justify-between items-start pt-5">
          <div className="w-full flex flex-col justify-between items-start py-2">
            <label className="text-sm text-black p-2">
              Choose the category of your request
            </label>
            <select
              name="item_category"
              id="item_category"
          ...
          <div className="w-full flex flex-col justify-between items-start py-2">
            <label className="text-sm text-black p-2">
              Enter address{" "}
              <span className="text-xs">(drop address of items)</span>
            </label>
            <textarea
              name="item_address"
              id="item_address"
